...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function logout() {
    ...
    ['tms_user','tms_access_token','tms_refresh_token'].forEach(k => localStorage.removeItem(k));
    router.push('/login');
  }
  ...
  return { user, accessToken, refreshToken, isLoggedIn, login, logout, refreshAccessToken, fetchMe, changePassword };
});
